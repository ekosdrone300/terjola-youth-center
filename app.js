...
async function apiCall(action, data = {}) {
  try {
      ...
      // 💥 ვფილტრავთ ფარულ დოკუმენტს, რომ კლუბებში არ გამოჩნდეს 💥
...
// 💥 UI ფუნქციები და Real-time Status შესწორებული კოლექციით 💥
window.onload = async function() {
  
  // სისტემის სტატუსის მოსმენა "clubs" კოლექციიდან
...
async function submitRegistration() {
   ...
   // 💥 რობოტექნიკის ასაკობრივი შეზღუდვის შემოწმება 💥
   ...
   if (isRoboticsSelected && classLevel < 6) {
       // გაფრთხილება მეგობრული და განმარტებითი ტექსტით
...
// 💥 გადამისამართდა ახალ "clubs/system_status" დოკუმენტზე 💥
