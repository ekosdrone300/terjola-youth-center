...
// PWA Service Worker-ის რეგისტრაცია აპლიკაციის დასაინსტალირებლად
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('/sw.js')
      .then(registration => {
        console.log('ServiceWorker წარმატებით დარეგისტრირდა', registration.scope);
      })
      .catch(error => {
        console.log('ServiceWorker-ის რეგისტრაცია ვერ მოხერხდა:', error);
      });
  });
}